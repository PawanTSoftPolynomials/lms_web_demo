  ...
  return (
    <DropdownMenuPrimitive.Portal>
      <DropdownMenuPrimitive.Content
        ...
        className={cn(
          "z-50 min-w-[10rem] overflow-hidden rounded-xl border border-card-border bg-popover p-1.5 text-popover-foreground shadow-xl",
...
function DropdownMenuLabel({
  ...
  return (
    <DropdownMenuPrimitive.Label
      data-inset={inset}
      className={cn(
        "px-2.5 py-1.5 text-[10px] font-bold uppercase tracking-wider text-muted-foreground data-[inset]:pl-8",
        className
      )}
      {...props}
    />
...
function DropdownMenuSubTrigger({
  ...
  return (
    <DropdownMenuPrimitive.SubTrigger
      data-inset={inset}
      className={cn(
        "flex cursor-pointer select-none items-center rounded-lg px-2.5 py-2 text-xs font-semibold outline-none focus:bg-muted data-[state=open]:bg-muted data-[inset]:pl-8",
        className
      )}
      {...props}
    >
...
function DropdownMenuSubContent({
  ...
  return (
    <DropdownMenuPrimitive.SubContent
      className={cn(
        "z-50 min-w-[8rem] overflow-hidden rounded-xl border border-card-border bg-popover p-1.5 text-popover-foreground shadow-xl",
        className
      )}
      {...props}
    />
