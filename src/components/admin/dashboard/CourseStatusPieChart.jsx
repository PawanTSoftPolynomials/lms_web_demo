  ...
  return (
    <div className="rounded-2xl bg-[#0D1021] border border-[#1A1F35] p-5 h-full flex flex-col">
      <div className="flex items-center justify-between mb-2">
        <h3 className="text-sm font-black text-slate-200">Course Status</h3>
      </div>

      <p className="text-[10px] text-slate-500 mb-4">Published vs. draft courses across the platform.</p>
