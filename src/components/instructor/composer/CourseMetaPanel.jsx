...
export default function CourseMetaPanel({ course, courseId }) {
  ...
  return (
    <div className="rounded-2xl border border-slate-800 bg-slate-900/50 backdrop-blur-md p-6 space-y-4 max-w-2xl">
      <h2 className="text-xl font-black text-white">Course Settings</h2>
      ...
      <div className="space-y-2">
        ...
        <textarea
          ...
          rows={4}
          className="w-full rounded-lg border border-slate-700 bg-slate-800 px-4 py-3 text-sm outline-none focus:border-orange-500 resize-y"
        />
      </div>
      ...
      <div className="flex justify-end pt-2 border-t border-slate-800">
        <button
          ...
          className="inline-flex items-center gap-1.5 px-4 py-2 text-sm font-bold text-white bg-orange-500 hover:bg-orange-600 rounded-xl shadow-sm transition disabled:opacity-50"
        >
