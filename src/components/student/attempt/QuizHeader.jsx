        ...
        <div className="flex items-center gap-3 rounded-xl border border-slate-800 bg-slate-900/80 px-4 py-2.5">
            {onBack ? (
                <button
                    ...
                    className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg text-slate-400 transition hover:bg-slate-800 hover:text-orange-400 cursor-pointer bg-transparent border-0 outline-none"
                >
                ...
                <Link
                    ...
                    className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg text-slate-400 transition hover:bg-slate-800 hover:text-orange-400"
                >
                    <ArrowLeft className="h-4 w-4" />
                </Link>
            )}
