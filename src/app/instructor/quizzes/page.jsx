...
export default function QuizzesPage() {
  ...
  // Global Quiz Search, Filters & Pagination States
  ...
  // Reset quiz page when filters change
  useMemo(() => {
    setCurrentPage(1);
                          ...
                          >
                            ...
                            <td className="p-5 pr-6" onClick={(e) => e.stopPropagation()}>
                              <div className="flex items-center justify-center gap-2">
                                <Link href={`/instructor/courses/${quiz.courseId}/quizzes/${quiz.id}/questions/create`}>
          ...
          >
            ...
            <div className="space-y-4">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                ...
                <Link href={`/instructor/courses/${selectedQuiz.courseId}/quizzes/${selectedQuiz.id}/questions/create`}>
