      ...
      <form onSubmit={handleSave} className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          {activeTab === "Profile" && (
            <>
              {/* Profile information */}
              <div className="bg-background/50 border border-transparent/80 backdrop-blur-md rounded-2xl p-6 shadow-luxury-md">
                <h3 className="text-sm font-black text-foreground uppercase tracking-wider mb-6">Profile Information</h3>
                
                <div className="space-y-6">
                  {/* Photo selector */}
                  <div className="flex items-center gap-5">
                    <div className="h-16 w-16 rounded-full bg-primary/10 flex items-center justify-center font-black text-xl text-primary border border-primary/20">
                      {form.name ? form.name.charAt(0).toUpperCase() : "U"}
                    </div>
                    <div>
                      <button type="button" className="px-4 py-2 border border-transparent hover:bg-muted text-foreground rounded-xl text-xs font-bold transition shadow-sm cursor-pointer">
                        Change Photo
                      </button>
                      <p className="text-[10px] text-muted-foreground mt-2">JPG, PNG or GIF. Max size 2MB.</p>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full bg-background border border-transparent rounded-xl px-3.5 py-2 text-xs text-foreground outline-none focus:border-primary transition"
                        required
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        value={form.email}
                        disabled
                        className="w-full bg-background border border-transparent rounded-xl px-3.5 py-2 text-xs text-muted-foreground outline-none cursor-not-allowed"
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="w-full bg-background border border-transparent rounded-xl px-3.5 py-2 text-xs text-foreground outline-none focus:border-primary transition cursor-pointer"
                      />
                    </div>
              ...
              <div className="bg-background/50 border border-transparent/80 backdrop-blur-md rounded-2xl p-5 shadow-luxury-md">
                <h3 className="text-xs font-bold text-foreground uppercase tracking-wider mb-4">Profile Customization</h3>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex justify-between items-center text-xs font-semibold p-1 hover:bg-muted/55 rounded-lg transition">
                    <span className="text-foreground">Focus Topics</span>
                    <input
                      type="text"
                      value={form.focusTopics}
                      placeholder="e.g. Science, Maths"
                      onChange={(e) => setForm({ ...form, focusTopics: e.target.value })}
                      className="bg-background text-primary border border-transparent rounded px-2.5 py-0.5 text-[11px] font-semibold outline-none w-32 text-right"
                    />
                  </div>
                  <div className="flex justify-between items-center text-xs font-semibold p-1 hover:bg-muted/55 rounded-lg transition">
          ...
          {activeTab === "Preferences" && (
            <div className="bg-background/50 border border-transparent/80 backdrop-blur-md rounded-2xl p-5 shadow-luxury-md">
              <h3 className="text-xs font-bold text-foreground uppercase tracking-wider mb-4">Preferences</h3>
              
              <div className="space-y-4">
                <div className="flex justify-between items-center text-xs font-semibold p-1 hover:bg-muted/55 rounded-lg transition">
                  <span className="text-foreground">Default Video Quality</span>
                  <select
                ...
                <div className="flex justify-between items-center text-xs font-semibold p-1 hover:bg-muted/55 rounded-lg transition">
                  <span className="text-foreground">Download Over</span>
                  <select
          ...
          {activeTab === "Account" && (
            <div className="bg-background/50 border border-transparent/80 backdrop-blur-md rounded-2xl p-6 shadow-luxury-md space-y-6">
              <div>
                <h3 className="text-sm font-black text-foreground uppercase tracking-wider mb-2">Account Subscription</h3>
                <p className="text-xs text-muted-foreground">Manage your active plans, pricing options, and billing cycle.</p>
              </div>
              ...
              <div className="border-t border-transparent/80 pt-4 space-y-3 text-xs text-muted-foreground">
                <div className="flex justify-between"><span>Billing Cycle:</span><span className="text-foreground font-bold">Monthly</span></div>
                <div className="flex justify-between"><span>Next Payment Due:</span><span className="text-foreground font-bold">August 12, 2026</span></div>
          ...
          {activeTab === "Notifications" && (
            <div className="bg-background/50 border border-transparent/80 backdrop-blur-md rounded-2xl p-6 shadow-luxury-md space-y-6">
              <div>
                <h3 className="text-sm font-black text-foreground uppercase tracking-wider mb-2">Notification Preferences</h3>
                <p className="text-xs text-muted-foreground">Choose when and how you want to be notified by LMS.</p>
              </div>

              <div className="space-y-4">
                <label className="flex items-center gap-3 cursor-pointer p-2 rounded-xl hover:bg-muted/50 transition">
                  <input type="checkbox" defaultChecked className="accent-orange-500 h-4 w-4 rounded border-transparent" />
                  <div>
                    <span className="text-xs font-bold text-foreground block">Email Notifications</span>
                    <span className="text-[10px] text-muted-foreground block mt-0.5">Receive summary updates, grades, and calendar shifts via email.</span>
                  </div>
                </label>
                ...
                <label className="flex items-center gap-3 cursor-pointer p-2 rounded-xl hover:bg-muted/50 transition">
                  <input type="checkbox" defaultChecked className="accent-orange-500 h-4 w-4 rounded border-transparent" />
                  <div>
                    <span className="text-xs font-bold text-foreground block">Push Notifications</span>
                    <span className="text-[10px] text-muted-foreground block mt-0.5">Get instant alerts about live classes, chats, and assignments.</span>
                  </div>
                </label>

                <label className="flex items-center gap-3 cursor-pointer p-2 rounded-xl hover:bg-muted/50 transition">
                  <input type="checkbox" className="accent-orange-500 h-4 w-4 rounded border-transparent" />
                  <div>
                    <span className="text-xs font-bold text-foreground block">SMS Notifications</span>
                    <span className="text-[10px] text-muted-foreground block mt-0.5">Get urgent updates on your phone.</span>
                  </div>
                </label>
              </div>
            </div>
          ...
          {activeTab === "Privacy" && (
            <div className="bg-background/50 border border-transparent/80 backdrop-blur-md rounded-2xl p-6 shadow-luxury-md space-y-6">
              <div>
                <h3 className="text-sm font-black text-foreground uppercase tracking-wider mb-2">Privacy & Data</h3>
                <p className="text-xs text-muted-foreground">Control who can see your learning milestones and stats.</p>
              </div>
          ...
          {activeTab === "Security" && (
            <div className="bg-background/50 border border-transparent/80 backdrop-blur-md rounded-2xl p-6 shadow-luxury-md space-y-6">
              <div>
                <h3 className="text-sm font-black text-foreground uppercase tracking-wider mb-2">Change Password</h3>
                <p className="text-xs text-muted-foreground">Ensure your account is using a long, secure random password.</p>
              </div>
          ...
          {activeTab === "Connected Apps" && (
            <div className="bg-background/50 border border-transparent/80 backdrop-blur-md rounded-2xl p-6 shadow-luxury-md space-y-6">
              <div>
                <h3 className="text-sm font-black text-foreground uppercase tracking-wider mb-2">Connected Accounts</h3>
                <p className="text-xs text-muted-foreground">Link third-party accounts for faster single-sign-on access.</p>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between p-2 hover:bg-muted/50 rounded-xl transition">
                  ...
                  <button type="button" className="text-xs font-bold text-muted-foreground hover:text-foreground cursor-pointer">Connect Account</button>
                </div>
              </div>
            </div>
          )}
          ...
          <div className="flex items-center gap-4 pt-2">
            <button
              ...
              className="px-6 py-2.5 bg-primary hover:bg-orange-600 text-foreground rounded-xl text-xs font-bold transition shadow-sm disabled:opacity-50 flex items-center gap-2 cursor-pointer"
            >
        ...
        <div className="space-y-6">
          ...
          {/* Quick Settings list */}
          <div className="bg-background/50 border border-transparent/80 backdrop-blur-md rounded-2xl p-5 shadow-luxury-md">
            <h3 className="text-xs font-bold text-foreground uppercase tracking-wider mb-4">Quick Settings</h3>
            
            <div className="space-y-4">
              <div
                onClick={() => setActiveTab("Notifications")}
                className="flex justify-between items-center text-xs font-semibold p-1 hover:bg-muted/55 rounded-lg cursor-pointer transition"
              >
                <span className="text-foreground flex items-center gap-2">🔔 Notification Settings</span>
              ...
              <div
                ...
                className="flex justify-between items-center text-xs font-semibold p-1 hover:bg-muted/55 rounded-lg cursor-pointer transition"
              >
                <span className="text-foreground flex items-center gap-2">🔒 Security Settings</span>
                <span className="text-primary font-bold">&gt;</span>
              </div>

              <div className="flex justify-between items-center text-xs font-semibold p-1 hover:bg-muted/55 rounded-lg transition">
                <span className="text-foreground flex items-center gap-2">☀️ Theme Mode</span>
                <button
                  type="button"
          ...
          <div className="bg-background/50 border border-transparent/80 backdrop-blur-md rounded-2xl p-5 shadow-luxury-md">
            <h3 className="text-xs font-bold text-foreground uppercase tracking-wider mb-4">Active Sessions</h3>
            
            <div className="space-y-3">
              <div className="flex items-center justify-between p-2 hover:bg-muted/55 rounded-xl transition cursor-pointer">
